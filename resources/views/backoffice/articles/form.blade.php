...
@section('content')
    <div class="container">
        ...
        <div>
            <form method="POST" action="{{ $action }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="5"
                              maxlength="5000">{{ old('content', $article->content) }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <input id="priority" type="number"
                                   ...
                                   name="priority" value="{{ old('priority', $article->priority) }}">
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-8 offset-md-3">
                        ...
                        @if(isset($id) && Auth::user()["role"]>2)
                            <a class="btn btn-danger" href="{{ route('article.destroy', $article) }}"
            ...
            @if(isset($id) && true)
                <form id="destroy-form" action="{{ route('article.destroy', $article) }}" method="POST"
                      style="display: none;">
                    @method('DELETE')
                    @csrf
                </form>
