                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        ...
                        <div class="d-flex flex-wrap">
                            <a class="btn btn-primary mr-3" href="{{ route('backoffice.order.edit', ['order' => $order]) }}">
                                Éditer la commande manuellement
                            </a>
                            <form class="form-inline" method="POST" action="{{ route('backoffice.order.destroy', ['order' => $order]) }}">
                                @csrf
                                @method('DELETE')
