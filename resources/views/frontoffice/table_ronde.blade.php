    ...
    <div class="row">
        <div ass="card-columns table_ronde">
          <div class="card carre">
            <img class="card-img-top perso" src="{{ Storage::url('images/membres/pere_blaise.jpg') }}" alt="pere_blaise">
            <div class="card-body">
          ...
          <div class="card carre">
            <img class="card-img-top perso" src="{{ Storage::url('images/membres/guenievre.jpg') }}" alt="Guenievre">
            <div class="card-body">
