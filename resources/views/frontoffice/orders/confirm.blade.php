            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputSubject" aria-describedby="emailHelp"
                           placeholder="adresse">
                    <small id="emailHelp" class="form-text text-muted">Précisez l'adresse de livraison dans St
                        Etienne</small>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputSubject" aria-describedby="emailHelp"
                           placeholder="téléphone / messager">
                    <small id="emailHelp" class="form-text text-muted">Précisez un moyen de vous contacter en cas de
                        besoin</small>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    ...
                    <small id="emailHelp" class="form-text text-muted">Informations de livraison
                        complémentaire, </small>
